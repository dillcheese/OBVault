...
_Coddled by the Plot_
> Required: Ah, yes. My anti-[X] Technique. I haven't used this since the Heian Era. 

You now constantly acquire new Skills or Powers that have the exact strength necessary to solve their reason of existence—though still limited by the SP cap—but where before you needed to desire or need something for them to develop now merely existing is enough for your power to gift you Powers/Skills. You could go to lay in your bed and suddenly have the power to always be wearing comfortable cloths, or walk outside and not need sunscreen even in the most sunny days. These Skills/Powers are still bound to the three loss conditions.
...
Required:Teaching
Required:Learning
Your extensive knowledge of both learning and teaching has significantly enhanced your own learning ability. You now learn 15 times faster, and those you teach experience improvements as if they had the 'Rapid Learning' perk and 'Learning' skill.
...
Cost: 5 SP
Cost: 10 CP
You become a blind spot for Thinkers.
...
You become immune to powers that directly affect your mind, emotions, or senses. This also protects against perception filters, hypnotic tinker-tech, body control or possession, and all forms of memetic hazards.  
...
*Blood-Brain Barrier*
Required:Frankenstein

You also gain immunity to physical effects like drugs, pheromones, and parasites.
...
Blindspot? Hah! Your powers have no blindspots. They can see Eidolon, The Endbringers, The Entity, Mantellum, and all other blind spots.  
Your power does have one blindspot, anyway... it cannot see those with the Blank perk.

**Only A Sith Deals in Absolutes**
Cost: 5 SP
Incompatible:No Powers

What happens when the unstoppable force meets the immovable object, which wins? The answer is now simple, which one do you want to win?  
...
Your mind automatically stores and processes any and all information your senses encounter, even if for but a moment. If new information provides context for one you already possessed, it automatically forms logic links. This allows you to grasp complex topics after skimming through a book without requiring any additional time to comprehend its contents.

**Fan Service**
Cost: 10 CP
Incompatible:Entity

Now, calling you beautiful or handsome would be a massive understatement. While you are still recognisably you, your appearance has been overhauled to become an idealised version of yourself. The magnitude of this enhancement can be anywhere from being more attractive than a supermodel to making a goddess of beauty jealous.  
  
Nothing can ever tarnish your looks. Unless you desire otherwise, any wounds you receive will heal perfectly and not leave any scars, you will not gain weight, visible muscle mass, body hair, or retain any other unwanted physical changes that can be healed, etc. Even sick and injured, you will look magnificent.

*Siren's Voice*
Required:Master (Hypnotist)
Required:Taming
Required:Shaker/Master (Speaker)
Required:Present Perfect

Before, you would have turned heads, and now you can become the center of attention if you wish, as you know how to make the most of what you have to influence others. Your instinctual control over all aspects of your actions allows you to tailor your behavior to work in the best way on those around you, whether they are normal people, animals, or even supernatural beings, with your voice standing out the most. Your voice is like molten chocolate in the ears of others—so beautiful that it can bring out the best in people and stop conflicts between them with just a few words.  
  
Your ability to influence animals and implant ideas into people has merged into this, making it even more powerful. You know how to make someone fall under your spell within moments of meeting them, implanting ideas into all living creatures. Even the smallest things, like a whistle or a hand gesture, can activate them as sleeper agents, with your voice alone being able to greatly influence both people and animals.  

Aside from controlling others, this is also effective in conveying complex signals, allowing others to pick up on the general idea of the message or helping you build a successful career in show business, where people can't get enough of you.  
Most would mistake you for a Parahuman or even someone blessed by Aphrodite.

**Smouldering**
Cost: 5 CP

You will always experience dramatic moments where you _smoulder_—whether it's while admiring a breathtaking sunset or locking eyes with a formidable opponent. These moments also include simple poses made to highlight your good side. These intense, captivating moments are never unnoticed; there will always be someone nearby to witness and appreciate your presence.

*Magnetic Presence*
Required:Dramatics
You possess a dramatic flair that ensures you are always the center of attention. Everything you do, whether intentional or not, draws the eyes and ears of those around you. Your presence is naturally magnetic, effortlessly capturing the attention of any audience. This manifests through both verbal and non-verbal cues, from the way you speak to your gestures and even your silences. You exude an aura that can be felt by everyone, making you impossible to ignore. This flair allows you to navigate any situation with a natural gravitas, ensuring that you leave a lasting impression on everyone you encounter.  
You can turn this on or off at will.

**Adorable**
Cost: 5 CP

You are Adorable. No matter what you do or say, people will find you completely adorable. You can be covered in blood and people will still find you too cute to resist, if a bit creepy. This affects your subconscious actions and both conscious actions and physical appearance to a limited degree. You can toggle this Perk on and off.
...
The fate or "canon" of this world is molded by those much higher than yourself, and unless intentionally acted against, shall follow the same path. Unless you involve yourself directly in the events foretold by Wildbow, everything shall follow the path he laid out more or less.  
Arriving on a Crossover or an Alternate Earth will also ensure that they'll follow the path laid out by their respective author(s) unless you directly involve yourself.
...
**Note**: This doesn’t do a thing if someone just mind controls you into believing that something happened in the past, such as you being their childhood friend, it's only if history actually changes. If you want immunity to that, get _Mental Barrier_ or something.

*Ripple Effect Proof Body*
...
If you have _**Golden Perks**_ as well, you can reject _any_ retroactive changes to your body, no matter how much stronger the source is compared to you.  
...
Any teleportation or similar power you possess now allows you to travel to other universes. You can travel to any universe you have previously been to, including your home universe, as well as target universes based on any knowledge you possess, such as memories you had prior to gaining powers, awareness of a setting through some form of media, etc.  
...
If you possess any means to travel across the multiverse, you can choose to re-enter any universe you have previously been to at the exact same time you left it, no matter how much time has passed. This includes your original world.  
If you have any powers that allow you to interact with other universes without actually moving to them, they will count as if you were there when used.
...
Now you can selectively conceal your true capabilities. When doing so, no device or ability will be able to detect your hidden powers.  
You can either conceal any or all of your powers and skills completely, appearing as if you never possessed them in the first place, hide only one some aspects of those, or, alternatively, just limit the detectable level of strength, appearing weaker than you truly are.

*Red Herring*
Required:Explained
You now have control over how others interpret the nature of any and all of your powers and abilities. For example, you can disguise any of your powers so that they appear to belong to a completely different power system, such as masking your magic powers as psionics and vice versa. This is so powerful that even if the nature of powers may be revealed through something like a blood test, everyone will still come to the conclusion that your powers are exactly what you present as.  
  
While not granting you any direct buffs, as the nature of your powers doesn't truly change, if something in the world is conditioned upon you having the right nature of power, you can appear as if you satisfy any such requirement.

**Accentuate the Positive**
Cost: 8 SP
Cost: 8 CP

You are now immune to the negative side effects of power sources from outside yourself, whether it be combat drugs, enchantments, items, divine blessings, curses, and anything that empowers you or that you wield in some manner.  
  
This means that if a drug could enhance your strength tenfold but reduced your life by half, you could take it as you please with no worry for the cost as it doesn’t impact you.  
...
This allows you to benefit from all the positives of outside power sources, with any negative mechanics and complications wiped away or shifted to be non-detrimental, such as a demonic force’s natural weakness and aversion to holy objects. However, it would not add new aspects; it removes negative effects and factors, but doesn’t create new beneficial ones.
...
Likewise, any aspect of your abilities that negatively affects your mental state, your body, your soul, or any other aspect of yourself is wiped away or shifted to a non-detriment.  
  
Are you a Kryptonian weak to Green Kryptonite? Now chuck that useless rock as if it was some common quartz rock. Let those grunts think they have a chance because they’ve got their magic bullet only to laugh in their face as that bullet does nothing.  

Your magic leaves you barely able to stand, fog your mind, or scar your soul? Not anymore. Fire as many spells as you wish—your health, body, mind, and soul remains unfazed. Your magic instead drains from a separate pool that replenishes over time.  
Your bloodline grants you the power to enter a form that gives phenomenal cosmic power in exchange for giving up your humanity? Feel free to shift back and forth as you wish. Enjoy the benefits of remaining who you were with all the pleasure of having all that power.  
  
The perk doesn’t expand upon the power, nor does it add new abilities; it merely removes the complications that may arise from the power.  
This allows you to benefit from all the positives of your powers. Any drawbacks, powers, biological traits, or magic systems that may have held any negative complication or mechanics have been wiped away or shifted to be non-detrimental. However, it would not add new aspects; it removes negative effects and factors but doesn’t create new beneficial ones.  
It would remove a Kryptonian's natural weakness to Green Kryptonite, but not their dependence on sunlight, nor would it grant new abilities for perceived limitations.
...
For example, as a Kryptonian, Green Kryptonite would amplify your power, pushing you as far away in strength from your normal form as you are to humans.  
...
In some universes, certain champions of justice travel through the atmosphere at superluminal speeds without igniting everything for miles and lift buildings, even though they should crumble due to structural integrity. Now, so can you.  
  
Not only do you have any required secondary powers that your primary powers might require to be used without horrifying or destructive implications, but, provided you have the powers for it, you can lift buildings without them falling apart and move at speeds in the multiple digits without destroying everything if you don't want to.  
  
You now have complete control over the amount of collateral damage your attacks can output such that a planet-busting punch will only affect your enemy, not the planet itself. It all just works.
...
*Joys of Friendship, Passion of Rivalry*
Required:Communication
Required:Connection

Some people might think you're the child of a Shounen Hero and a Magical Girl, given how easily you can form and maintain so many friendships at once. These bonds are genuine and deep, and they begin to have a positive impact on those you connect with.  
  
As a result, they become better at communicating their feelings and intentions to others. Having someone with whom they can speak frankly allows them to grow in ways they might not have been able to if they were alone. Gaining the encouragement to take risks or stand up for themselves are just a few examples of how you and your friendships uplift each other, making each of you better than before.  
This improvement can also be seen in rivals. At first, it may seem like you and they are only getting better at defeating each other and others, but as time goes on, both you and they find other aspects of your lives improving thanks to having someone to compete against. Even something as simple and complex as ideals is refined through this conflict between you.  
For you, friendship almost seems like a power in itself. Though, no giant friendship lasers included—you'll have to look elsewhere for that.

**A Significant Other**
Cost: 5 CP
Incompatible:Lonely

Through a stroke of fate, you either have or will soon find your soulmate. Maybe you’ve yet to meet them, or maybe—if you are a reincarnation—you already have prior history together; every single detail is completely up to you. You can leave this entirely to chance, or you may optionally choose now whom this may be, anyone of your choice. Either way, when you next cross paths, you’ll both immediately and unmistakably know that you’re meant for each other.  
  
They are matched to your ideal in every way, and you are the same for them. Whether it’s a romantic interest, a friendship, or anything else—you're perfect for each other. You get along easily and flawlessly, your bond is unbreakable, you're both willing to go to hell and back for one another and support each other to be the best versions of yourselves, and every bit of love is reciprocated. All you need is each other, and even if that’s all you had, it would still be the happiest time of your life.  
...
**Peaceful Life**
Cost: 10 CP
Incompatible:Always on The Clock

With all those troubles that come with a super life, you can never have enough "me time". This Perk helps you by letting all your troubles take a "day off". An eldritch monster is trying to devour reality, and you are the only one who can stop it? Relax, it won't happen until you have your "free day".  
...
You can change how any aspects of any of your powers, objects of powers, or perks work. This doesn't make it more powerful but can change some of its mechanics.  
  
You can use this to alter the mechanics of some of your powers or OoPs, a single one of them, fuse all of them or allow them to be expressed through one power or object, or any combination of alterations you can think of. This doesn’t allow you to make yourself more powerful on its own.

**Tailor Made**
Cost: 2 SP
Required: Power Tweak (All)

Your powers, OoPs, and perks are all adjusted to fit you perfectly. The little nuances and the subtle details that you may have otherwise overlooked or miscalculated are no longer an issue, instead all the little nuances and details are smoothed out entirely on their own to become the best possible fit for you.

*Personal Touch*
Required: Thematic
Your powers, objects of powers, and perks aren’t just fixed in at one point in time; instead, they’ll alter and shift to continuously match you perfectly.  
This also allows you to manually make adjustments at will, freely shifting it to suit your needs. If you prefer, you can always allow it to default back to shifting into an optimal state for you once more.
...
Each generation’s inherent power is much greater than the previous, capable of inheriting a far more powerful version of their predecessor’s abilities. They will suffer no difficulty because of the increase in potency. You can also control whether they inherit a different expression of your abilities and what differences they possesses, as well as scale back anything they would inherit if you wish.  
...
Your Perks have evolved, making them an order of magnitude stronger. For example, if before, a Perk protected your mind from most of the attacks, it would now protect it from everything. Should a Perk not be able to go a tier higher, it would develop beneficial side effects that expand the scope of what it can do.

**I Don't Get It**
Cost: 1 SP

_Gaze your eyes, tune your ears._  
_Witness the snap of sanity, the scream of existence unraveling._  
_Feel it, hear it, understand... absolutely nothing._  
...
I Get It Now... But Not Really...?
Required: Invictus, or Well-Adjusted

Now, instead of being unbothered by everything because you are unable to comprehend it, now you are unbothered by everything because even though you get everything, you just simply don't get what about it bothers others.  
...
An odd situation normally comes up if you're not from a certain universe or were originally not from there—would certain universal concepts or restrictions apply to you?  
This perk settles that—now, you’re immune to any negative concepts and restrictions resulting from a setting’s interactions, rules, and metaphysics.  
Whereas taking the Psyker power may have made you vulnerable to the Warp corrupting or devouring your soul in the 40k universe—now, you’re treated as if you were utilizing your power in a foreign setting with no Warp, no soul, and no corruption, regardless of whether you possess a soul or not.  
  
If you went to the Nasuverse and Shiki Tohno's Mystic Eyes of Death Perception were used against you, their power would be ineffective, as you are not connected to the Root or to that setting’s concept of death.  
This only affects negative effects; positive ones are retained and applied as normal.  
Likewise, if a positive effect from one setting would no longer apply to you if you traveled to another, you can choose to retain it and apply it to yourself. You can toggle this on and off at will.  
You can also choose to apply this to other beings, items, specific power systems, or any other factors, allowing you to implant them with this ability when they cross worlds.  

Note: it doesn’t make you entirely immune to others' abilities—only to the negative effects that would not otherwise apply due to the setting’s rules.

**Continuity Of Existence**
Cost: 5 SP

Whether you are reborn as a clone, uploaded into a machine, pieced together by hands not your own, or even revived through a ritual better left unexamined, you will remain undeniably yourself. Your soul is never lost or severed in the process, always carrying with it your memories, personality, and all of your powers. What others might call a “copy” is no mere imitation—it is you in truth, seamless and unbroken, the same being in whatever form you inhabit.  
...
Cost: 10 SP 
Required:(Trump) As the Plot Demands
The Skills/Powers you receive are no longer temporary. 

**Favored by the Plot** 
Cost: 15 SP 
Required:(Trump) As the Plot Demands
The SP cap is raised to 20 SP and the Powers/Skills you receive will always come at the exact strength necessary to deal with the situation you wanted/needed them for as long as it doesn't exceed the SP cap.
...
What can affect organics but not inorganics can now affect both, what is weakened in the presence of living beings now isn't, what can't teleport something to inside something else now can, for your powers never gained the shackles called Manton Limit.

**New Target Acquired**
Cost: 7 SP

Your powers have what they can affect expanded; more specifically, if you have a power that can only affect others, it can now affect you and if you have a power that can only affect you, now it can affect others. Of course, those new targetings still use the same vectors as the original ones, so if you want to use Panacea on yourself, you would need to do something like touching your face with your hand.

*Unshackled*
Required:Bypass

What your powers can affect slowly expands to include similar things and may even develop new ways to interact with them, the stronger the new targets and interactions are the longer they take to come. As a example, (Master/Thinker) Confetti could gain the capacity to control paper itself, and later acquire the capacity to separate and meld paper, later would be able to increase the durability and sharpness of your paper.  
Use of yours powers will make those expansions come faster.

**Second Sight**
Cost: 7 SP

Any power that copies or creates powers will now give you the option to instead gain the power one Trigger Event higher. If you take this option, the newly developed power or power copied from someone who has only triggered once will work as if they were it was the Second Trigger version of that power. Any power copied from someone who has a Second Trigger could work as if the original user had gone through the hypothetical third trigger, and so on.  
  
Any power that goes through this second or third trigger will gain new features and upgraded potential at the cost of putting a heavier power strain on the shard that the power comes from. For example, removing a touch-based power's Manton Limit on touch while enforcing other of the power's aspects as a offset.

**Shard Automation**
Cost: 5 SP

Your power will now automatically catalogue any powers that come within a 100 meter radius of you, recording its blueprint.  
  
This will allow you to subconsciously know how you can replicate a power, its effects, and/or its principles using your own existing abilities, such as using a shaker power that could feasibly reproduce the effect of someone’s blaster power.  
In the event you possess a power that allows you to replicate and/or produce powers, it will give your power a mental blue print to build the power and its principles, allowing you to use it as a basis to start with, although the resources needed to make the power would have to be spent as normal. You can also use this to branch out into other expressions or possible powers.  
If your power allows you to replicate and/or copy a power, your power can now do so at will as it would as if they were present, even if they aren’t, using the mental blueprint in its stead.  
The range will begin at a minimum of 100 meters. But it also allows you to piggyback off the range and vectors of any powers you possess to enhance this, including powers that operate on line of sight or have a range greater than 100 meters, potentially extending it significantly.

*Catalogue*
Required:Archive

Your power now has an infinite [ARCHIVE] of every possible and potential power, component, combinations, fusions, variations, and expressions.  
  
This comes with a number of secondary thinker powers to manage this.  
The first is [PARSE], the ability to immediately parse through your archive to find exactly what you’re looking for, subconsciously aware of any possibilities and able to bring it up to the forefront for use.  
The second is [INTUIT], the ability to intuitively understand any blueprint, power, etc. on an instinctive level, as well as a perfecting your ability to replicate other powers/effects through your existing powers, becoming effortless and seamless.  
This allows you the ability to intuit every detail, quirk, and application of a power you either possess or come across, as well as its underlying nature and features, in addition to granting natural and effortless control over any power you possess or otherwise encounter.  
  
This also makes you an incredible teacher, capable of understanding any ability you encounter and helping them uncover new applications, as well as providing you insight into possible weaknesses against enemies.  
As before, this provides the blueprints and information needed to build powers/abilities for power creation power, it doesn’t reduce the cost of producing the power.

**Quality Over Quantity**
Cost: 10 SP

You now passively improve the density of all forms of energy you have access to, both internal and external. The higher the density, the more effective your energy is in the same quantity. By actively working to improve the density of your energies, you will eventually be able to increase the quality of the energy you are working on. Achieving an increase in quality is a momentous event, as a higher quality energy will be able to perform in an entirely different realm from the base form. Quality increases allow for more flexibility and creativity with the improved energy, loosening the bindings that you'd normally be subject to.

**AOE Manipulation**
Cost: 10 SP

Your area of effect (AOE) powers have become more malleable, allowing you to manipulate the shape of your AOEs. You can freely move an AOE's point of origin to another location, or even bind it to an object or being, causing the AOE to move when it's linked mass moves. Another facet of this increased malleability is the ability to diffuse or condense your AOEs in a tradeoff between strength and coverage. Keep in mind the tradeoff is in area, not distance, so if you want to make your 2x as big in every dimension, it would cost 8x the power. The maximum power that can gained from reducing area is capped at 64x, though you can reduce area further if you so desire.

**Power Stockpile**
Cost: 25 SP

You have a power stockpile that stockpiles the excess energy from your powers. Any time when a power isn't actively being used at 100%, it instead fills this stockpile with energy that can later be used to boost your other powers. Purely synergistic powers that don't do anything on their own don't give energy, as they don't have any mass excess that could be utilized. The excess energy gained from a power is proportional to both it's SP cost and how much of it is currently unused, and the same applies to the costs when boosting a power. This isn't perfectly efficient, causing you only to gain half as much energy as you should.  

**Creation vs. Destruction**
Cost: 15 SP

Powers come in various shapes and sizes, but the vast majority bottle down to two noticeable differences. Creation and Destruction. This upgrade forces you to choose between which one you’ll have an inherent affinity towards. Meaning if you select Creation, you’ll find all of your powers and abilities that align with it steadily increasing in arbitrary fields like potency, speed, and efficacy, with their advancement never stopping, eventually becoming virtually unrecognizable from their base counterparts. The inverse is also true if you would select destruction.  
This ability can partially work on certain powers, such as Divine Magic being empowered when smiting foes, but losing the bonus when creating barriers on allies.

**Automatic Defense**
Cost: 5 SP
Required: (Thinker) Danger Sense, or Sixth Sense

Your powers now operate much more smoothly, requiring almost no conscious effort on your part. Your danger sense is also much more refined, capable of intuiting a much greater deal of information, almost acting as form of clairvoyance.  
Your ability to anticipate danger is now tied directly to your reflexes and other powers, allowing your powers to act in your defense, even when you’re unaware, unconscious, or otherwise incapacitated. They’ll automatically move your body out of the way such as activating your flight, teleporting you away, or even simply moving your body’s muscles reflexively to defend you.  
...
**Autonomous**
Cost: 5 SP
Required:Automatic Defense

All of your powers are now operating under a single premise: if you were to want it to happen, it will. You’ll never fail to activate your flight when you jump off a building, won’t accidentally drop your force field because you got distracted, never forget to return to human form before making your way through a small door, etc.  
The same goes for any constructs you may create with your power, with them now capable of acting as you would wish them to even when not aware. They’ll collect information if you normally would wish them to, they’ll fight an enemy if you would normally direct them to do so, etc. They’re capable of acting entirely autonomously, always acting in a manner that you would agree with.

**Natural**
Cost: 5 SP

You have an uncanny and natural aptitude for your abilities, as if the usage and talent was ingrained into your instincts.  
You possess absolute and perfect control and understanding over all your powers, granting instinctive mastery and knowledge over your powers, able to control your power in its every manifestation as effortlessly as breathing, from its most explosive and powerful manifestation to its most subtle nuances.

**Absolute Authority**
Cost: 30 SP

For one of your chosen powers that grants you control over some kind of domain, be it element, concept, or anything else, your connection to this domain becomes absolute, making you its sole embodiment and granting you absolute authority over it. If someone tries to manipulate your domain through any means, even if they possess perfect copies of your power, your authority will effortlessly supersede all their attempts to do so. Moreover, you are always aware of any such attempt and can block it if you so desire. You can limit the level of awareness so it does not become a constant distraction.  
  
As your existence is irreversibly tied to your chosen domain, your ability to manipulate it cannot be separated from you by any means. Even if the power that originally allowed you to control the domain is stolen, suppressed, or otherwise manipulated, it will not hinder you in the slightest, and the power itself will eventually be restored.  
  
Lastly, as you now embody your chosen domain, you will live as long as there is even the smallest trace of it in existence or even beyond it, constantly regenerating from the most grievous wounds or even complete obliteration. You also serve as an origin point, ensuring the endless generation of the element or concept constituting your domain in a self-perpetuating cycle.  
Note: this upgrade does not grant the mastery over domain by itself; as such, it will be useless without some other power. And your initial ability to wield it will still be tied to this power, although you will be able to effortlessly discover new and creative uses of your domain.

*White Hole*
Required:Endless Reserves

You can now generate an endless amount of your chosen element, as well as make infinite sources of it, like a never-extinguishing fire, an endless well of water, or an infinite source of mana for use by yourself or others.

*Artifactorio*
Required: Thinker/Master (Organized Mind), or Quantum Supremacy
Required: Thinker/Master (Autopilot), or Toposophic Emergence

You can now program portions of your element with an algorithm for a certain behaviour, which it will continuously execute even if you are not in range to actively influence it, as if you were controlling it manually, or even allow this programmed portion to receive commands, mental or otherwise, from other designated users.  
This will even allow you to create semi-conscious elementals, whose behaviour you can program in any way you want.
...
**Ah, yes. My anti-[X] Technique. I haven't used this since the Heian Era.**
Cost: 10 SP

You have the uncanny ability to randomly "remember" a technique, spell, power, or unique expression of your power that happens to be the right ability to either counter or mitigate whatever negative thing you're going against.  
